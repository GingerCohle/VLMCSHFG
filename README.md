...
#### We also contribute by providing COCO-format annotations, since the original annotations are in Pascal VOC format. The converted annotations have been uploaded to *xxx*.
