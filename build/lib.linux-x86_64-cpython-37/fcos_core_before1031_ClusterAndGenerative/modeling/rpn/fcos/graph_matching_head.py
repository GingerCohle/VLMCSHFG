...
class GModule(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        self.COCO_CLASSES = ('person', 'car', 'train', 'rider', 'truck', 'motorcycle', 'bicycle', 'bus', "pedestrian")
    ...
    def _forward_train(self, images, features, targets=None, score_maps=None,centerness = None):
            ...
            if nodes_2 is not None:
                ...
                try:
                    ...
                    #print("clip_crop_feat_src_batch",type(clip_crop_feat_src_batch),clip_crop_feat_src_batch.size())
                    #clip_crop_feat_src_batch =
                    ...
                    print("hello something wrong with clip and the length of clip_crop_feat_src_batch ")
                    supconloss = 0.0
